...
def test_alphanumeric_output_is_correct(bit_stream: BitStreamSender, encoder: Encoder) -> None:
    ...
    r = encoder.alphanumeric_encode("HELLO WORLD")
    assert expected_output == bit_stream.send_bit_stream(r[2], r[0], r[1])
